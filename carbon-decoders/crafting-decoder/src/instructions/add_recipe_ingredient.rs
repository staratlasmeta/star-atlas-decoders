...
#[carbon(discriminator = "0xb9b55279bfece704")]
pub struct AddRecipeIngredient {
    pub input: AddRecipeIngredientInput,
}

#[derive(Debug, PartialEq, Eq, Clone, Hash, serde::Serialize, serde::Deserialize)]
pub struct AddRecipeIngredientInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for AddRecipeIngredient {
    type ArrangedAccounts = AddRecipeIngredientInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(AddRecipeIngredientInstructionAccounts {
            location,
            authority,
            crafting_process,
            recipe,

...
impl TryFrom<crate::instructions::postgres::EditRow> for EditGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::EditRow) -> Result<Self, Self::Error> {
        Ok(Self {

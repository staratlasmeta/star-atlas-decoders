...
#[carbon(discriminator = "0x3502685433c5b30a")]
...
pub struct MintCertificateInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for MintCertificate {
    type ArrangedAccounts = MintCertificateInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        let certificate_token_to = next_account(&mut iter)?;
        ...
        Some(MintCertificateInstructionAccounts {

...
impl CpiEventRow {
    pub fn from_parts(source: CpiEvent, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            name: match &source {
                CpiEvent::BattleLog(_) => "battle_log".to_string(),
                CpiEvent::CombatInitiatedEvent(_) => "combat_initiated_event".to_string(),
                CpiEvent::CombatLogEvent(_) => "combat_log_event".to_string(),
                CpiEvent::CombatLootDropEvent(_) => "combat_loot_drop_event".to_string(),
                CpiEvent::CombatParticipant(_) => "combat_participant".to_string(),
                CpiEvent::CombatResolvedEvent(_) => "combat_resolved_event".to_string(),
                CpiEvent::StarbaseCombatEvent(_) => "starbase_combat_event".to_string(),
            },

...
#[carbon(discriminator = "0x5d5ce968d27495c4")]
pub struct IncrementLevel {
    pub input: IncrementLevelInput,
}

#[derive(Debug, PartialEq, Eq, Clone, Hash, serde::Serialize, serde::Deserialize)]
pub struct IncrementLevelInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for IncrementLevel {
    type ArrangedAccounts = IncrementLevelInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(IncrementLevelInstructionAccounts {
            category,
            user_points_account,

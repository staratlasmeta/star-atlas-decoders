...
impl CpiEventRow {
    pub fn from_parts(source: CpiEvent, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            name: match &source {
                CpiEvent::ApproveLockPrivilegeEvent(_) => {
                    "approve_lock_privilege_event".to_string()
                }
                CpiEvent::ExitEscrowEvent(_) => "exit_escrow_event".to_string(),
                CpiEvent::LockEvent(_) => "lock_event".to_string(),
                CpiEvent::NewEscrowEvent(_) => "new_escrow_event".to_string(),
                CpiEvent::NewLockerEvent(_) => "new_locker_event".to_string(),
                CpiEvent::RevokeLockPrivilegeEvent(_) => "revoke_lock_privilege_event".to_string(),
                CpiEvent::LockerSetParamsEvent(_) => "locker_set_params_event".to_string(),
                CpiEvent::SetVoteDelegateEvent(_) => "set_vote_delegate_event".to_string(),
            },
